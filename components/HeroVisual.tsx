  ...
  return (
    <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-2xl border border-border bg-background-secondary">
      ...
      <div className="absolute inset-[15%] flex flex-col items-center rounded-3xl border border-border bg-white px-[10%] pt-[10%] shadow-sm">
        ...
        <div className="mt-8 h-3.5 w-full rounded-full bg-border" aria-hidden />
        <div className="mt-3 h-2.5 w-4/5 rounded-full bg-border" aria-hidden />

        <div className="mt-6 flex w-full justify-center gap-2" aria-hidden>
          <span className="h-8 flex-1 rounded-lg bg-accent" />
          <span className="h-8 flex-1 rounded-lg border border-border bg-white" />
          <span className="h-8 flex-1 rounded-lg border border-border bg-white" />
        </div>

        <p className="mt-auto mb-[10%] text-sm text-foreground-muted">
          {siteConfig.role}
        </p>
      </div>
    </div>
